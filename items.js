...
const fileList = [require(fileLoc + "axe.json"), require(fileLoc + "pickaxe.json"), require(fileLoc + "materials.json"), , require(fileLoc + "pole.json"), require(fileLoc + "upgrades.json"), , require(fileLoc + "blueprints.json")];
